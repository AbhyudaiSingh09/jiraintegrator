...
class ConfluenceConfig(BaseSettings):
    confluence_uploader_url: str = "https://{domain}/wiki/api/v2/pages/{confluence_page_id}"
    ...
    EMAIL: str
    API_TOKEN: str
    model_config = SettingsConfigDict(env_file=".env")  # Points to .env file for sensitive info
    ...
    def api_token_v1(self) -> str:
        ...
        return base64.b64encode(f"{self.EMAIL}:{self.API_TOKEN}".encode()).decode('utf-8')
